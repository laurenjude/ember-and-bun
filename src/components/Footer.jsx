      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-10">
        <div>
          <img
            src="/logo.png"
            alt="Ember & Bun"
            className="max-h-[44px] w-auto mb-4"
          />
          <p className="text-white-muted text-sm font-body">
          ...
          <ul className="flex flex-col gap-2 font-body text-sm">
            <li>
              <a
                ...
                className="text-white-muted hover:text-amber transition-colors">
                Home
              </a>
            </li>
            <li>
