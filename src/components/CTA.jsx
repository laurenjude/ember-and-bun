...
export default function CTA() {
  ...
  return (
    ...
    >
      <div ref={ref} className="fade-in-section max-w-2xl mx-auto text-center flex flex-col items-center gap-5">
        <img src="/logo-icon.png" alt="Ember & Bun icon" loading="lazy" className="w-[60px] mb-2" />
        ...
        <a
          ...
          aria-label="Call our AI agent now"
        ...
        <span className="text-amber font-heading font-semibold uppercase text-sm">Call Now</span>
